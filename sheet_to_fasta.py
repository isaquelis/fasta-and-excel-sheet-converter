...
for i in range(2, sheet_seq.max_row + 1):
    sequencesList.append(SeqRecord(
        ...
        id = ('head|' + sheet_seq.cell(row = i, column = 3).value + '|'),
...
fastaOutputName = input("Define FASTA-file name: ")
SeqIO.write(sequencesList, fastaOutputName + ".fasta", "fasta") # To write FASTA file with a seqRecord objects list.